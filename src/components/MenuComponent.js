        ...
        if (maquina != null)
            return(  
                <Card className="card-view">
                    <CardBody>
                        <CardTitle>&#9881;</CardTitle>
                      <CardTitle><h5>{maquina.name}</h5></CardTitle>
                      ...
                      <CardText>
                            ...
                            Consumo Corrente:<h4>30A</h4></CardText>          
                    </CardBody>              
                </Card>   
            );
        else
    ...
    render() {
        const menu = this.props.maquina.map((maquina) => {
            ...
            return (
                ...
                <Card className="col-12 col-md-4 m-1" style={{ width: '15rem' }} key={maquina.id}
                  onClick={() => this.onMaquinaSelect(maquina)}>              
                    
                      <CardTitle className="card-box-header">&#9881;{maquina.name}</CardTitle>
